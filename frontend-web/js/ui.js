...
export function footer(){ return `<footer class="cc-footer"><div class="cc-container grid md:grid-cols-3 gap-6"><div><h3 class="text-xl font-bold">CommerCity</h3><p>Marketplace académico y comercial para compradores, vendedores y administradores.</p></div><div><h3 class="font-bold">Ayuda</h3><p><a href="terms.html">Términos</a> · <a href="privacy.html">Privacidad</a> · <a href="recovery-password.html">Recuperar acceso</a></p></div><div><h3 class="font-bold">Seguridad</h3><p>Proxy Nginx, pagos sandbox, roles y auditoría administrativa.</p></div></div></footer>`; }
